...
template <class T> class Dynamic_Array1 : public Dynamic_Array<T,1>
    {
      using Dynamic_Array<T,1>::partial;
      using Dynamic_Array<T,1>::bounds;
      using Dynamic_Array<T,1>::elements;
    public:
...
template <class T> class Dynamic_Array2 : public Dynamic_Array<T,2>
    {
      using Dynamic_Array<T,2>::partial;
      using Dynamic_Array<T,2>::bounds;
      using Dynamic_Array<T,2>::elements;
    public:
...
template <class T> class Dynamic_Array3 : public Dynamic_Array<T,3>
    {
      using Dynamic_Array<T,3>::partial;
      using Dynamic_Array<T,3>::bounds;
      using Dynamic_Array<T,3>::elements;
    public:
...
template <class T> class Dynamic_Array4 : public Dynamic_Array<T,4>
    {
      using Dynamic_Array<T,4>::partial;
      using Dynamic_Array<T,4>::bounds;
      using Dynamic_Array<T,4>::elements;
    public:
