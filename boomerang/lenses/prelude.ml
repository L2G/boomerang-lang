...
let prelude_spec =
  ...
  ; (S.mk_native_prelude_qid "columnize",
     ...
     mk_sfun (Info.M "columnize built-in") (S.SRegexp ^> S.SString ^> S.SString ^> S.SCanonizer) (fun i k -> 
       mk_rfun i (S.SString ^> S.SString ^> S.SCanonizer) (fun i r -> 
  ...
  ; begin 
    ...
    (S.mk_native_prelude_qid "poly_concat",
     ...
     mk_poly_fun (Info.M "poly_concat built-in") a (a ^> a) (fun i v1 -> 
       mk_poly_fun i a a (fun i v2 ->
         match v1,v2 with
           ...
           | _            -> poly_bin_error i a a (sort_of_t v1) (sort_of_t v2))))
    end
  ...
  ; begin 
    ...
    (S.mk_native_prelude_qid "poly_union",
     S.mk_scheme [alpha] (a ^> a ^> a),
     mk_poly_fun (Info.M "poly_union built-in") a (a ^> a) (fun i v1 -> 
       mk_poly_fun i a a (fun i v2 ->     
         match v1,v2 with 
  ...
  ; begin 
    ...
    (S.mk_native_prelude_qid "poly_iter",
     ...
     mk_poly_fun (Info.M "poly_iter built-in") a (S.SString ^> S.SString ^> a) (fun i v1 -> 
  ...
  ; begin 
    ...
    (S.mk_native_prelude_qid "poly_swap",
     S.mk_scheme [alpha] (a ^> a ^> a),
     mk_poly_fun (Info.M "poly_swap built-in") a (a ^> a) (fun i v1 -> 
       mk_poly_fun i a a (fun i v2 ->     
         match v1,v2 with 
