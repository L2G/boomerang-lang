...
<ul> <li> First, try changing the rating of Lovesong in the view.
...
<li> Next try changing the quantity of Trust in the view to 1.  Notice
that the quantity gets propagated to the database.  
Exercise: What do
you think will happen if you try to change the quantity to 1?

<li> Delete the tuple (Trust, 4, Wish, 5) from the view and
...
<li> Finally, take a look at the tuple (Paris, 4, Lovesong, 5) in the
